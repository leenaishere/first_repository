...
public class EmployeeController {
	...
	// http://localhost:8080/api/employees/empList
	@GetMapping(value="/empList",produces="application/json")
	public List<Employee> getAllEmployees() throws EmployeeException{
		return employeeService.getEmployeeList();
	}
	
	// http://localhost:8080/api/employees/getEmp/1
	@GetMapping(value="/getEmp/{empId}",produces="application/json")
	...
	//http://localhost:8080/api/employees/updateEmp/1
	...
	//http://localhost:8080/api/employees//deleteEmp/1
